...
// Content-Security-Policy is disabled here because public/index.html is a
// single self-contained page that relies on inline <script>/<style> blocks
// (no separate bundled JS/CSS files exist to point a stricter policy at).
// Helmet's other protections (frameguard, noSniff, etc.) stay on.
...
// Serves public/index.html at "/" (the login/app screen) and public/privacy.html
// at "/privacy.html" — this is what makes the bare Render URL show the app
